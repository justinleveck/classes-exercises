...
class SubClassesTest < Minitest::Test
  ...
  class CoachSeat < AirlineSeat
  end

  class BusinessClassSeat < AirlineSeat
  end
  ...
  def test_airline_seat_has_instance_method_aisle?
    assert AirlineSeat.instance_methods.include?(:aisle?)
  end

  def test_airline_seat_has_instance_method_middle_seat?
    assert AirlineSeat.instance_methods.include?(:middle_seat?)
  end
  ...
  def test_coach_seat_has_instance_method_aisle?
    assert CoachSeat.instance_methods.include?(:aisle?)
  end

  def test_coach_seat_has_instance_method_middle_seat?
    assert CoachSeat.instance_methods.include?(:middle_seat?)
  end
  ...
  def test_business_class_seat_has_instance_method_aisle?
    assert BusinessClassSeat.instance_methods.include?(:aisle?)
  end

  def test_business_class_seat_has_instance_method_middle_seat?
    assert BusinessClassSeat.instance_methods.include?(:middle_seat?)
  end
